...
class MedicinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicine" do
    assert_difference('Medicine.count') do
      post medicines_url, params: { medicine: { brand_name: @medicine.brand_name, cost: @medicine.cost, dosage_form: @medicine.dosage_form, generic_name: @medicine.generic_name } }
    end
  ...
  test "should update medicine" do
    patch medicine_url(@medicine), params: { medicine: { brand_name: @medicine.brand_name, cost: @medicine.cost, dosage_form: @medicine.dosage_form, generic_name: @medicine.generic_name } }
