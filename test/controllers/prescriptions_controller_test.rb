...
class PrescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prescription" do
    assert_difference('Prescription.count') do
      post prescriptions_url, params: { prescription: { date_prescribed: @prescription.date_prescribed, doctor_id: @prescription.doctor_id } }
    end
  ...
  test "should update prescription" do
    patch prescription_url(@prescription), params: { prescription: { date_prescribed: @prescription.date_prescribed, doctor_id: @prescription.doctor_id } }
